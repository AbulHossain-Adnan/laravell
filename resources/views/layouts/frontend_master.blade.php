                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <ul class="d-flex account_login-area">
                            ...
                            <li><a href="{{url('Customer_register')}}"> Customer/Register </a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="search-cart-wrapper d-flex">
                                  ...
                                  <?php foreach (App\Carts::where('ip_address',request()->ip())->get() as $cart): ?>
                                    <li class="cart-items">
                                        ...
                                        <div class="cart-content">
                                            ...
                                            <span>QTY :{{App\Product::find($cart->product_id)->product_quantity}}</span>
                                            <p>{{App\Product::find($cart->product_id)->product_price}}</p>
                            ...
                            <li>
                                <a href="javascript:void(0);"><i class="flaticon-shop"></i> <span>
                                  {{App\Carts::where('ip_address',request()->ip())->count()}}
                                </span></a>
                                <ul class="cart-wrap dropdown_style">
                                @php
                                $subtotal=0;
                                @endphp
                                    ...
                                    <li>
                                      <a href="{{url('addcart')}}" class="btn btn-danger">Cart</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
